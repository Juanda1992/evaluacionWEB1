    ...
    <main>
        ...
        <div class= "container">
            <div class="row justify-content-center">
                ...
                <form class = "mt-5" action="indexImc.php" method="POST"> 
                     <h4>Calculo de IMC</h4>
                    <div class="row">
                        <div class="col">
                    ...
                    <button type="submit" class= "btn btn-primary mt-5" name="botonCalcular">Calcular IMC </button>
                </form>
